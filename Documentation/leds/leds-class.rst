...
Hardware driven hw control mode transition
==========================================
...
- "none" => hw control trigger (offloaded):
        ...
        mode transition, this is essentially a no-op and returns success.
...
- hw control trigger (offloaded) => "none"
        ...
        transition, this is essentially a no-op and returns success.

        The deactivation sequence for the hw control trigger will be executed as
        normal, except for the current LED brightness is retained. The reason
